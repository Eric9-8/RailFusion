...
OPTIONS.add_argument('--id', type=str, default='imf_fusion_1_5', help='Unique experiment identifier.')
    ...
    def train(self):
        ...
        for data in tqdm(dataloader_train):
            ...
            output = model(gaf0 + gaf1 + gaf2 + gaf3 + gaf4 + gaf5 + gaf6 + gaf7 + gaf8 + gaf9 +
                           ...
                           gaf20 + gaf21 + gaf22 + gaf23 + gaf24 + gaf25 + gaf26 + gaf27 + gaf28 + gaf29, rail)
